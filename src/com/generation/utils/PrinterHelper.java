...
public class PrinterHelper
{
    ...
    public static Student createStudentMenu( Scanner scanner )
    {
        ...
        try {
            ...
            //use System.err.println because it will show Red on the commandlinee
            System.err.println("Invalid date format. Make sure you type date using the following format: MM/dd/yyyy");
        }
        System.out.println( "|-------------------------------------|" );
